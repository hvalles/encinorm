...
- [ ] 02-10-PLAN.md — Validate `QueryBuilder`'s `_table` (constructor) and each join target's `_table` with the strict allowlist, and sweep every remaining interpolation point — closes GAP A / CR-01 — DIAL-01, DIAL-02
